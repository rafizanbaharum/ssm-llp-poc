...
<div id="height-wrapper">
    ...
    <div role="main" class="container_12" id="content-wrapper">
        ...
        <div id="main_content">
            <h2 class="grid_12">Non Allowable Name in Your LLP</h2>
                ...
                <div class="box">
                    ...
                    <div class="content no-padding">
                        <table class="table">
                            ...
                            <tbody>
                            <tr>
                                <td class="wwe-1rank"><span>1</span></td>
                                <td class="wwe-align-left">MALAYSIA</td>
                                <td>COUNTRY</td>
                            </tr>
                            <tr>
                                <td class="wwe-1rank"><span>2</span></td>
                                <td class="wwe-align-left">IRELAND</td>
                                <td>COUNTRY</td>
                            </tr>
                            <tr>
                                <td class="wwe-1rank"><span>3</span></td>
                                <td class="wwe-align-left">KUALA LUMPUR</td>
                                <td>STATE</td>
                            </tr>
                            <tr>
                                <td class="wwe-1rank"><span>4</span></td>
                                <td class="wwe-align-left">AL ARABI</td>
                                <td>OFFENSIVE</td>
                            </tr>
                            <tr>
                                <td class="wwe-1rank"><span>5</span></td>
                                <td class="wwe-align-left">AL FARABI</td>
                                <td>OFFENSIVE</td>
                            </tr>
                            <tr>
                                <td class="wwe-1rank"><span>6</span></td>
                                <td class="wwe-align-left">AL MAJU</td>
                                <td>OFFENSIVE</td>
                            </tr>
                            </tbody>
                        </table>
