...
<head>
    ...
    <link rel="stylesheet" href="css/h5bp/non-semantic.helper.classes.css">
    <!-- RECOMMENDED: H5BP helpers (e.g. .clear or .hidden) -->
    <link rel="stylesheet" href="css/h5bp/print.styles.css">
    ...
    <!-- Sprites styling -->
    <link rel="stylesheet" href="css/sprite.forms.css">
    <!-- SPRITE: Forms styling -->
    <link rel="stylesheet" href="css/sprite.lists.css">
    <!-- SPRITE: Lists styling -->
    <link rel="stylesheet" href="css/icons.css">
    <!-- Icons -->
    <!-- Styling of JS plugins -->
    <link rel="stylesheet" href="css/external/jquery-ui-1.8.16.custom.css">
...
<div id="main_content">
    ...
    <div class="grid_12">
        <div class="alert info">
            ...
            <strong>Information</strong> Hey there! Welcome to the clean and smooth admin template "Peach". I hope you
            enjoy your stay and please make sure, that you visit the other pages.
        </div>
    ...
    <div class="grid_4">
        <div class="box">
            <div class="header">
                <img src="img/icons/packs/fugue/16x16/document--plus.png" alt="" width="16"
                     height="16">
    ...
    <div class="grid_4">
        <div class="box">
            <div class="header">
                <img src="img/icons/packs/fugue/16x16/ui-accordion.png" alt="" width="16"
                     height="16">
            ...
            <div class="content">
                <div id="accordion">
                    ...
                    <h4><a href="#">Financial Tasks</a></h4>

                    <div>
                        <p>
                            Nam enim risus, molestie et, porta ac, aliquam ac, risus. Quisque lobortis.
                            Phasellus pellentesque purus in massa. Vivamus hendrerit, dolor at aliquet laoreet, mauris
                            turpis porttitor.
                        </p>
                        <ul>
                            <li>
...
<script defer src="js/mylibs/jquery.ba-resize.js"></script>
<!-- RECOMMENDED when using sidebar: page resizing -->
<script defer src="js/mylibs/jquery.easing.1.3.js"></script>
<!-- RECOMMENDED: box animations -->
<script defer src="js/mylibs/jquery.ui.touch-punch.js"></script>
...
<script
        defer>window.attachEvent('onload', function() {
