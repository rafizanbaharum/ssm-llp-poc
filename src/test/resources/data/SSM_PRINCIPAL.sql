...
insert into SSM_USER (ID, REALNAME, PASSWORD, EMAIL, ACTOR_ID) values (1, 'System Root', 'abc123', 'rafizan.baharum@gmail.com', null);
...
insert into SSM_USER (ID, REALNAME, PASSWORD, EMAIL, ACTOR_ID) values (2, 'SSM User 1', 'abc123', N'rafizan.baharum@gmail.com', null);
